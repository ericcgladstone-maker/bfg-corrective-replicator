...
COMMON="--scalars 1.0 --reps 20 --vreapers top_fitness --slots 10"

echo "=== SWEEP 3: inter-peak distance (6 levels, fresh) ==="
...
echo "=== SWEEP 2: extinction-timing (5 firing gens, fixed 250-gen recovery window) ==="
